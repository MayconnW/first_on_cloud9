class VendasController < ApplicationController
  ...
  private
    ...
    def venda_params
      params.require(:venda).permit(:imei, :dataemissao, :cliente_id, :obs, :data_prev_entrega, :total_bruto, :total_liquido, :desconto, :acrescimo, :planospagamento_id, :status, :vendedor, :hora)
    end
end
